...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/TM54QOGKFKLCDDESLNURKQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/data
AST_DATA_PATH=/tmp/applifire/db/TM54QOGKFKLCDDESLNURKQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/data
MYSQL=/usr/bin
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$ART_DATA_PATH/art_log_events_t_old.csv' into table art_log_events_t_old FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '#appfirenewline#' ";
