...
ART_CREATE_PATH=/tmp/applifire/db/TM54QOGKFKLCDDESLNURKQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/create
AST_CREATE_PATH=/tmp/applifire/db/TM54QOGKFKLCDDESLNURKQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
...
$MYSQL/mysql -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $ART_CREATE_PATH/art_log_events_t_old.sql";
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/ast_ShopABC_T.sql"; 
