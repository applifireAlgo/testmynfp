Ext.define('Test2.test2.web.com.controller.shopdb.shopdomain.ShopABCMainController', {
     extend: 'Test2.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.ShopABCMainController',
     init: function() {
          var form = this.view.down('#ShopABCForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#ShopABCTree');
               ...
               var compRef = this.view.down('#ShopABCTree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#ShopABCGrid');
          var tree = this.view.down('#ShopABCTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#ShopABC');
          var grid = this.view.down('#ShopABCGrid');
          var tree = this.view.down('#ShopABCTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#ShopABCForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, opts) {
                    ...
                    var compRef = currentView.down('#ShopABCTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var ShopABC = this.view.down('#ShopABCForm');
               ShopABC.reset();
               var gridPanel = this.view.down('#ShopABCGrid');
          ...
          var formPanel = this.getView().up().down('#ShopABCForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#ShopABCTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#ShopABC').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#ShopABCGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
