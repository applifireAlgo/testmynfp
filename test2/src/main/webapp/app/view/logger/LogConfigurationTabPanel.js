...
Ext
		.define(
				'Test2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Test2.view.logger.tabs.details.DetailsTab',
							'Test2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Test2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Test2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Test2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Test2.view.logger.LogConfigurationTabPanelController',
