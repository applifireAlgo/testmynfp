 ...
 * 
 */
Ext.define('Test2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Test2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
