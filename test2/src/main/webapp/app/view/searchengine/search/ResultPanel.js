Ext
		.define(
				'Test2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Test2.view.searchengine.search.SearchEngineMainPanelController','Test2.view.searchengine.search.PanelHeaderField' ,'Test2.view.searchengine.search.ReportGridView','Test2.view.searchengine.search.ReportChartView','Test2.view.searchengine.search.documentView','Test2.view.searchengine.search.DouMeanView','Test2.view.googlemaps.map.MapPanel'],
