 ...
 * 
 */
Ext.define('Test2.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Test2.view.logalarm.LogAlarmMainViewController',
			'Test2.view.logalarm.tree.LogAlarmTreePanel',
			'Test2.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
