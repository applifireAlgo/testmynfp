Ext.define('Test2.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Test2.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Test2.view.console.ConsoleWindow');
