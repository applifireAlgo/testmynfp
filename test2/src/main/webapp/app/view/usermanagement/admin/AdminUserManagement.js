Ext.define('Test2.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Test2.view.usermanagement.admin.UserPasswordReset',
	            'Test2.view.usermanagement.admin.AddUserDetails',
	            'Test2.view.usermanagement.admin.ViewUser'],
