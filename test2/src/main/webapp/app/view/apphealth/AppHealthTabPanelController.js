 ...
 * 
 */
Ext.define('Test2.view.apphealth.AppHealthTabPanelController',{
	extend : 'Ext.app.ViewController',
	alias : 'controller.appHealthTabPanelController',
	requires : ['Test2.view.apphealth.AppHealthConnector'],
						...
						success : function(response, opts){
							...
							if (responseJson.response.success) {
								...
								for(var i = 0; i < appHealthSchedulerData.length; i++)
								{
									...
									var connectorPanel = Ext.create("Test2.view.apphealth.AppHealthConnector", {
