...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("IkGn6hUsCm");
        question.setQuestionIcon("rTNGEGUKflxQtWA1cfmmksxJRYYVZpSK5ZJbcfmWCN8GEed5DR");
        question.setQuestion("0nQpeUmNn7KFfxQPOG2RSi3lR5pnlu35j7h39g6IKDzoxUDUVT");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("SiwKKVVAEw");
            question.setQuestionIcon("aVFLIgr260Pw9hkX9tNX14svQ55N7ziB9nwcsVXDTZIusNAAjC");
            question.setQuestion("Y8mtZVEXvzYeJutNmjUQWA8WFKy15tt7g73f8xcaqsnY7AGgsu");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "vhcTk8SAXXVV3qTNFM3MxEZqj7vMIqxHD9rQYkZ3KIPajh8fFR5yRrSATjZCDicLp"));
