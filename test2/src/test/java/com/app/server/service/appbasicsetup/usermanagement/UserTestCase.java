...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainName("3fPquxTp0H0OwC82t6oDsoZ9gr0nGHSF8t1pm1pqSFDergiyy0");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainDescription("qycB4luTH60E6k61GYhQxz5f9BkldycCY1PTobUnrNMXZkVcmb");
        useraccessdomain.setDomainIcon("aPakzKZiWnnC3co9KLd9BK15YCOsNfhNqkXDNcxSEuuqB5PUfh");
        useraccessdomain.setDomainHelp("TaVTMPBVj9KMIdGtK9PqVhnKqIA6VBhh16Mv4S9AskjU669an0");
        ...
        useraccesslevel.setLevelHelp("8GajpgsfaiObSNecc1J7gUGSMC2St865qDvJz6Jsex8gOAE5bA");
        useraccesslevel.setLevelDescription("9kMJt56UdSD3CyBNZYfjsErPeYcmMUS0ZfRMZIkzqBlZDpBd5e");
        useraccesslevel.setLevelName("ujxiertHOwKaLxpWihhQkwIJs4gghi0gythW9cJ3qAqeIOLSFv");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("fKfOCSiotY6n3uZTPDeeHYCqxDOq29lWWMmabzdX9T4SZuUBPS");
        ...
        User user = new User();
        user.setSessionTimeout(3051);
        user.setIsDeleted(1);
        user.setIsLocked(1);
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setGenTempOneTimePassword(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1462963823021l));
        user.setChangePasswordNextLogin(1);
        user.setMultiFactorAuthEnabled(1);
        user.setPasswordAlgo("iho2MvuRaE73hHqRNijsVQmtCDsgeh5OkGNyiekNuIuROJonPh");
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1462963823022l));
        user.setUserAccessCode(14010);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setAllowMultipleLogin(1);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        Question question = new Question();
        question.setQuestionDetails("ieq33pLbOE");
        question.setQuestionIcon("jJ1O6XpDHQcQRsVUowN4RmtubBUbHC50CizejJFmLmU1KmoItA");
        question.setQuestion("Q4YLpvlXls0mHuiFFpAKJpq1dtIYK4luzlMi9PumISBdkVIO3s");
        ...
        passrecovery.setAnswer("Ukv5cWTDyz8LeQL7q9ri6zUjOmzifDtOibgiSXJvDeAAIkOMFr");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordExpiry(6);
        userdata.setOneTimePassword("7FCJVbf227wsapd8jpPnBGnqNDlPhPtu");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1462963823201l));
        userdata.setPassword("k0xUC08BTC58rybLo2QRNiavKOscLO9oAgJiZKQ5IrOOI8XHFI");
        userdata.setOneTimePasswordExpiry(11);
        userdata.setOneTimePassword("kNGuDRtAspgZ0S4c7ziMLjLNM2ZpkXz2");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1462963823212l));
        userdata.setPassword("6dCKwh5Fj9BD7RAeYZXYN8eraClsZlpNeG0jHqqJmccxwEvzp6");
        userdata.setUser(user);
        userdata.setLast5Passwords("0asoxrtTTwUK7JBqaKUPsoilsyi28HzDxPuwu2VflrE2ezSqKK");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 83260));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "FPKeuKFEpCVlr4i1j5JfXSdfhTs2CERy0oJhZMLdI2YQ9nn1KsRAvNTKmUfAK8yXg"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 7082));
